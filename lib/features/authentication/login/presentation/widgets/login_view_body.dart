        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              Text('Welcome to Lafyuu', style: AppStyles.title),
              SizedBox(height: 8.h),
              Text('Sign in to continue', style: AppStyles.subtitle),
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('OR', style: AppStyles.divider),
                  ),
                  const Expanded(
                    child: Divider(color: borderLight, thickness: 1),
                  ),
              ...
              Row(
                ...
                children: [
                  Text("Don't have a account? ", style: AppStyles.body),
                  GestureDetector(
                    onTap: () => context.push(AppRouter.kRegisterView),
                    child: Text('Register', style: AppStyles.link),
                  ),
                ],
              ),
